        ...
        public IActionResult Create([FromBody] PokemonFormDto pokemonIn)
        {
            ...
            var pokemon = new PokemonCreateDto
            {
                ...
                PokemonSpeciesId = (_dataContext
                    .PokemonSpecies
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.PokemonSpecies.ToLower())!
                    .Id),
                ...
                AbilityId = _dataContext
                    .Abilities
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.Ability.ToLower())!
                    .Id,
                ItemId = _dataContext
                    .Items
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.Item.ToLower())!
                    .Id,
                MoveOneId = _dataContext
                    .Moves
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.MoveOne.ToLower())!
                    .Id,
                MoveTwoId = _dataContext
                    .Moves
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.MoveTwo.ToLower())!
                    .Id,
                MoveThreeId = _dataContext
                    .Moves
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.MoveThree.ToLower())!
                    .Id,
                MoveFourId = _dataContext
                    .Moves
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.MoveFour.ToLower())!
                    .Id,
                Level = int.Parse(pokemonIn.Level),
                Experience = int.Parse(pokemonIn.Experience),
                NatureId = _dataContext
                    .Natures
                    .FirstOrDefault(x => x.Name.ToLower() == pokemonIn.Nature.ToLower())!
                    .Id,
